...
const BC = {
  ...
  blue: "#1565C0", green: "#2ECC71", red: "#E74C3C", orange: "#F5B400",
};
...
function TableCard({ table, now, compact }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        display: "inline-block", marginTop: 4, padding: compact ? "2px 8px" : "3px 10px", borderRadius: 20,
      ...
      {playing && info && (
        <div style={{ marginTop: compact ? 4 : 8 }}>
          ...
          {!compact && (
            <div style={{ fontSize: 10, color: danger ? BC.red : BC.muted, fontWeight: 700, marginTop: 2 }}>
      ...
      {table.staffCount > 0 && (
        <div style={{
          marginTop: compact ? 4 : 8, display: "inline-block", padding: compact ? "1px 6px" : "3px 9px",
  ...
  return (
    <div style={{ ...F }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 14, fontWeight: 700 }}>全体の待ち人数</div>
          ...
          return (
            <div key={t.number} style={{
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
                {!playing ? (
                  <button onClick={() => startGame(t.number)} style={actionBtnStyle(BC.blue)}>対局開始</button>
                ) : (
                  <button onClick={() => endGame(t.number)} style={actionBtnStyle(BC.red)}>終了</button>
                )}
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: 12, color: BC.muted }}>スタッフ人数</div>
